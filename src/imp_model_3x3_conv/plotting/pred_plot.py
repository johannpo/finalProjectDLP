...
# --- 1. CONFIGURATION ---
PROJROOT = Path('/scratch/s4099265/dlp_project/final_project/output/improved_modular_run')
RUN_NAME = 'improved_fno_N1000_ep500_m12_w20_S64_step10'

DATA_FILE = PROJROOT / 'eval' / f'{RUN_NAME}_predictions.npz'
OUTPUT_DIR = PROJROOT
...
# Pick 4 specific timesteps to show the evolution
t_steps = sorted(set([
...
for i in range(num_samples):
    ...
    for col_idx, t in enumerate(t_steps):
        ...
        ax.set_title(f'Improved FNO t={t + 1}')
        ax.set_xticks([])
        ax.set_yticks([])
