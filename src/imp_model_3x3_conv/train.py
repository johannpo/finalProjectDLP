...
from model_components import ImprovedFNO2dMultiStepNoPadding
...
parser = argparse.ArgumentParser(description="Improved FNO 2D multi-step training without padding")
...
model = ImprovedFNO2dMultiStepNoPadding(modes, config.WIDTH, T_in, STEP).to(device)
...
print("Improved multi-step training without padding complete.")
