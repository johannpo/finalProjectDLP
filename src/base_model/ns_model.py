...
parser = argparse.ArgumentParser(description='FNO 2D Baseline Paper Replication')
parser.add_argument('--out_dir', type=str, default=None, 
                    help='Specific directory for all run outputs')
args, unknown = parser.parse_known_args()

if args.out_dir:
    OUTPUT_DIR = args.out_dir
else:
    OUTPUT_DIR = os.path.join(PROJROOT, 'output', 'default_run')
