...
TRAIN_PATH = os.path.join(DATAROOT, 'ns_V1e-3_N5000_T50.mat')
TEST_PATH = os.path.join(DATAROOT, 'ns_V1e-3_N5000_T50.mat')
...
OUTPUT_DIR = os.path.join(PROJROOT, 'output', 'improved_model_v2')
MODEL_DIR = os.path.join(OUTPUT_DIR, 'model')
EVAL_DIR = os.path.join(OUTPUT_DIR, 'eval')

RUN_NAME = f'improved_model_v2_N{NTRAIN}_ep{EPOCHS}_dim64'
